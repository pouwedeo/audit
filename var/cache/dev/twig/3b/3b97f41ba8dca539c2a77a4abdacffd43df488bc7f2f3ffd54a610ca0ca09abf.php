...
class __TwigTemplate_fd0ba333004053a2b0183e189be8b961f05e438df33664edfa6885beac759f8e extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 70, $this->source); })()), "session", [], "any", false, false, false, 70), "getflashbag", [], "any", false, false, false, 70), "get", [0 => "etape.succes"], "method", false, false, false, 70));
    ...
    ";
        ...
        echo "     ";
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 79, $this->source); })()), "session", [], "any", false, false, false, 79), "getflashbag", [], "any", false, false, false, 79), "get", [0 => "etape.erreur"], "method", false, false, false, 79));
        foreach ($context['_seq'] as $context["_key"] => $context["contenu"]) {
            // line 80
    ...
    <h1>Modification de l'étape</h1>
     ...
     <div class=\"col-lg-3\">
      ...
      <div class=\"col-lg-1\">
        <a href=\"";
        // line 95
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("etape_index", ["id" => (isset($context["ide"]) || array_key_exists("ide", $context) ? $context["ide"] : (function () { throw new RuntimeError('Variable "ide" does not exist.', 95, $this->source); })())]), "html", null, true);
        echo "\" title=\"Liste des étape\" data-toggle=\"tooltip\" data-placement=\"top\" class=\"btn btn-success btn-circle\">
...
<script>
 ...
 ";
    ...
    {
        return array (  307 => 108,  297 => 107,  282 => 102,  272 => 95,  263 => 88,  253 => 84,  247 => 80,  242 => 79,  232 => 75,  226 => 71,  222 => 70,  212 => 69,  195 => 62,  189 => 59,  185 => 57,  175 => 56,  159 => 50,  151 => 45,  143 => 40,  135 => 35,  124 => 27,  112 => 18,  104 => 13,  96 => 8,  91 => 5,  81 => 4,  62 => 3,  39 => 1,);
    }
...
{% endblock %}
{% block body %}
{% for contenu in app.session.getflashbag.get('etape.succes') %}
    ...
    {% endfor %}
     {% for contenu in app.session.getflashbag.get('etape.erreur') %}
  ...
  <div class=\"col-lg-8\">
    <h1>Modification de l'étape</h1>
     ...
     <div class=\"col-lg-3\">
      ...
      <div class=\"col-lg-1\">
        <a href=\"{{ path('etape_index',{'id': ide}) }}\" title=\"Liste des étape\" data-toggle=\"tooltip\" data-placement=\"top\" class=\"btn btn-success btn-circle\">
          <i class=\"fas fa-clipboard-list\"></i>
        </a>
      </div>
    </div>
...
<script>
 ...
 {% endblock %}", "etape/edit.html.twig", "C:\\wamp64\\www\\audit\\audit\\templates\\etape\\edit.html.twig");
    }
}
