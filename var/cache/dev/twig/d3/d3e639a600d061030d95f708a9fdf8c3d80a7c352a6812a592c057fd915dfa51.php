...
class __TwigTemplate_a7d5e187f0241d8f16eed52576de0b1869e105145e0e12878104edda1f6c63b5 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 68, $this->source); })()), "session", [], "any", false, false, false, 68), "getflashbag", [], "any", false, false, false, 68), "get", [0 => "personnel.succes"], "method", false, false, false, 68));
    ...
    ";
        ...
        echo "     ";
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 86, $this->source); })()), "session", [], "any", false, false, false, 86), "getflashbag", [], "any", false, false, false, 86), "get", [0 => "conteneur.erreur"], "method", false, false, false, 86));
        foreach ($context['_seq'] as $context["_key"] => $context["contenu"]) {
            // line 87
            echo "        <div class=\" text-center alert alert-danger\" role=\"alert\">
    ...
    <h1>Nouveau personnel</h1>
     ...
     <div class=\"col-lg-3\">
      ...
      <div class=\"col-lg-1\">
        <a href=\"";
        // line 102
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("personnel_index", ["id" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 102, $this->source); })())]), "html", null, true);
...
<script>
 ...
 ";
    ...
    {
        return array (  325 => 114,  315 => 113,  301 => 109,  291 => 102,  282 => 95,  272 => 91,  266 => 87,  261 => 86,  251 => 82,  245 => 78,  240 => 77,  230 => 73,  224 => 69,  220 => 68,  210 => 67,  194 => 61,  188 => 58,  184 => 56,  174 => 55,  158 => 49,  150 => 44,  142 => 39,  134 => 34,  123 => 26,  112 => 18,  104 => 13,  96 => 8,  91 => 5,  81 => 4,  62 => 3,  39 => 1,);
    }
  ...
  <div class=\"col-lg-8\">
    <h1>Nouveau personnel</h1>
     ...
     <div class=\"col-lg-3\">
      ...
      <div class=\"col-lg-1\">
        <a href=\"{{ path('personnel_index',{'id': id}) }}\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Liste des personnels\"  class=\"btn btn-success btn-circle\">
          <i class=\"fas fa-clipboard-list\"></i>
        </a>
      </div>
    </div>
...
<script>
 ...
 {% endblock %}", "personnel/new.html.twig", "C:\\wamp64\\www\\audit\\audit\\templates\\personnel\\new.html.twig");
    }
}
