...
class __TwigTemplate_8b7ceb7e891f117528f640b2b5a462516889db6c903f121d9ef4f0e0ce8feed1 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "   <div class=\"row\">
  <div class=\"col-lg-8\">
    <h1>suppression de l'utilisation de matière prémière</h1>
    </div>
     <div class=\"col-lg-3\">
     </div>
      <div class=\"col-lg-1\">
        <a href=\"";
        // line 77
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("matiere_utiliser_index", ["id" => (isset($context["ide"]) || array_key_exists("ide", $context) ? $context["ide"] : (function () { throw new RuntimeError('Variable "ide" does not exist.', 77, $this->source); })())]), "html", null, true);
    ...
    <table class=\"table\">
        <tbody>
            <tr>
                ...
                <td>";
        // line 88
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["matiere_utiliser"]) || array_key_exists("matiere_utiliser", $context) ? $context["matiere_utiliser"] : (function () { throw new RuntimeError('Variable "matiere_utiliser" does not exist.', 88, $this->source); })()), "id", [], "any", false, false, false, 88), "html", null, true);
        echo "</td>
            </tr>
             <tr>
                <th>Etape</th>
                <td>";
        // line 92
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["matiere_utiliser"]) || array_key_exists("matiere_utiliser", $context) ? $context["matiere_utiliser"] : (function () { throw new RuntimeError('Variable "matiere_utiliser" does not exist.', 92, $this->source); })()), "etape", [], "any", false, false, false, 92), "nom", [], "any", false, false, false, 92), "html", null, true);
        echo "</td>
            </tr>
             <tr>
                ...
                <td>";
        // line 96
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["matiere_utiliser"]) || array_key_exists("matiere_utiliser", $context) ? $context["matiere_utiliser"] : (function () { throw new RuntimeError('Variable "matiere_utiliser" does not exist.', 96, $this->source); })()), "matierepremiere", [], "any", false, false, false, 96), "nom", [], "any", false, false, false, 96), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
";
    ...
    {
        return array (  265 => 101,  257 => 96,  250 => 92,  243 => 88,  229 => 77,  220 => 70,  210 => 69,  194 => 62,  188 => 59,  184 => 57,  174 => 56,  158 => 50,  150 => 45,  142 => 40,  134 => 35,  123 => 27,  111 => 18,  103 => 13,  95 => 8,  90 => 5,  80 => 4,  61 => 3,  38 => 1,);
    }
  ...
  <div class=\"col-lg-8\">
    <h1>suppression de l'utilisation de matière prémière</h1>
     ...
     <div class=\"col-lg-3\">
      ...
      <div class=\"col-lg-1\">
        <a href=\"{{ path('matiere_utiliser_index',{'id': ide}) }}\" title=\"Liste des équipes\" data-toggle=\"tooltip\" data-placement=\"top\" class=\"btn btn-success btn-circle\">
          <i class=\"fas fa-clipboard-list\"></i>
        </a>
      </div>
    </div>
...
{% endblock %}
", "matiere_utiliser/show.html.twig", "C:\\wamp64\\www\\audit\\audit\\templates\\matiere_utiliser\\show.html.twig");
    }
}
