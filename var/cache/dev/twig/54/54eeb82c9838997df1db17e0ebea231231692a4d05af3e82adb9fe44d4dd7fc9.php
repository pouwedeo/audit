...
class __TwigTemplate_9b3dbb38d1dacbb554ae12c63b522e448718388bb9f2b76456e02943042f037b extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 69, $this->source); })()), "session", [], "any", false, false, false, 69), "getflashbag", [], "any", false, false, false, 69), "get", [0 => "travailler_personnel.succes"], "method", false, false, false, 69));
    ...
    ";
        ...
        echo "      ";
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 87, $this->source); })()), "session", [], "any", false, false, false, 87), "getflashbag", [], "any", false, false, false, 87), "get", [0 => "travail.erreur"], "method", false, false, false, 87));
        foreach ($context['_seq'] as $context["_key"] => $context["contenu"]) {
            // line 88
            echo "        <div class=\" text-center alert alert-danger\" role=\"alert\">
    ...
    ";
        ...
        echo " <div class=\"row\">
  <div class=\"col-lg-8\">
    <h1>Modification du groupe de personne par équipe</h1>
    </div>
     <div class=\"col-lg-3\">
     </div>
      <div class=\"col-lg-1\">
        <a href=\"";
        // line 103
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("travailler_personnel_index", ["id" => (isset($context["ide"]) || array_key_exists("ide", $context) ? $context["ide"] : (function () { throw new RuntimeError('Variable "ide" does not exist.', 103, $this->source); })())]), "html", null, true);
  ...
  <div class=\"col-lg-8\">
    <h1>Modification du groupe de personne par équipe</h1>
     ...
     <div class=\"col-lg-3\">
      ...
      <div class=\"col-lg-1\">
        <a href=\"{{ path('travailler_personnel_index',{'id': ide}) }}\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Liste des personnes par équipe\"  class=\"btn btn-success btn-circle\">
          <i class=\"fas fa-clipboard-list\"></i>
        </a>
      </div>
    </div>
...
<script>
 ...
 {% endblock %}", "travailler_personnel/edit.html.twig", "C:\\wamp64\\www\\audit\\audit\\templates\\travailler_personnel\\edit.html.twig");
    }
}
