...
class __TwigTemplate_f8423d6b546d38ca8a185ef562cef1e7f3490c4162203ecd32f8063cb02cfddb extends Template
{
    private $source;
    private $macros = [];
    ...
    <h1>Liste des productions </h1>
     ...
     <div class=\"col-lg-3\">
      ...
      <div class=\"col-lg-1\">
        <a href=\"";
        // line 75
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("produir_new", ["id" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 75, $this->source); })())]), "html", null, true);
        echo "\" title=\"Nouvelle production \" class=\"btn btn-success btn-circle\">
...
\t</br>
     ...
     <table class=\"table table-bordered\" id=\"example1\" width=\"100%\" cellspacing=\"0\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["produirs"]) || array_key_exists("produirs", $context) ? $context["produirs"] : (function () { throw new RuntimeError('Variable "produirs" does not exist.', 119, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["produir"]) {
            ...
            echo "            <tr>
                <td>";
            // line 121
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["produir"], "equipe", [], "any", false, false, false, 121), "nom", [], "any", false, false, false, 121), "html", null, true);
            echo "</td>
                <td>";
            // line 122
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["produir"], "produit", [], "any", false, false, false, 122), "nom", [], "any", false, false, false, 122), "html", null, true);
            echo "</td>

                <td>
                 <a href=\"";
            // line 125
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("produir_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["produir"], "id", [], "any", false, false, false, 125), "ide" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 125, $this->source); })())]), "html", null, true);
            echo "\" title=\"Modifier\" class=\"btn btn-info btn-circle btn-sm\"><i class=\"fas fa-pencil-alt\"></i> </a>
                 <a href=\"";
            // line 126
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("produir_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["produir"], "id", [], "any", false, false, false, 126), "ide" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 126, $this->source); })())]), "html", null, true);
...
\t";
    ...
    {
        return array (  380 => 149,  376 => 148,  371 => 146,  367 => 145,  363 => 144,  359 => 143,  355 => 142,  349 => 140,  339 => 139,  325 => 134,  316 => 130,  307 => 126,  303 => 125,  297 => 122,  293 => 121,  290 => 120,  285 => 119,  263 => 100,  256 => 96,  248 => 91,  229 => 75,  220 => 68,  210 => 67,  194 => 61,  188 => 58,  184 => 56,  174 => 55,  158 => 49,  150 => 44,  142 => 39,  134 => 34,  123 => 26,  112 => 18,  104 => 13,  96 => 8,  91 => 5,  81 => 4,  62 => 3,  39 => 1,);
    }
  ...
  <div class=\"col-lg-8\">
    <h1>Liste des productions </h1>
     ...
     <div class=\"col-lg-3\">
      ...
      <div class=\"col-lg-1\">
        <a href=\"{{ path('produir_new', {'id':id }) }}\" title=\"Nouvelle production \" class=\"btn btn-success btn-circle\">
          <i class=\"fas fa-check\"></i>
        </a>
      </div>
    </div>
...
\t</br>
     ...
     <table class=\"table table-bordered\" id=\"example1\" width=\"100%\" cellspacing=\"0\">
        ...
        {% for produir in produirs %}
            <tr>
                <td>{{ produir.equipe.nom }}</td>
                <td>{{ produir.produit.nom }}</td>

                <td>
                 <a href=\"{{ path('produir_edit', {'id': produir.id,  'ide':id}) }}\" title=\"Modifier\" class=\"btn btn-info btn-circle btn-sm\"><i class=\"fas fa-pencil-alt\"></i> </a>
                 <a href=\"{{ path('produir_delete', {'id': produir.id, 'ide':id}) }}\" title=\"Supprimer\" class=\"btn btn-danger btn-circle btn-sm\"><i class=\"fas fa-trash\"></i> </a>
                </td>
            </tr>
        {% else %}
            <tr>
...
\t
\t{% endblock %}
", "produir/index.html.twig", "C:\\wamp64\\www\\audit\\audit\\templates\\produir\\index.html.twig");
    }
}
