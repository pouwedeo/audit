...
class __TwigTemplate_a7c44ecd15c16bb559b7a4eafa3577e38905f4f6501ff8b7f610da0afa06ea41 extends Template
{
    private $source;
    private $macros = [];
    ...
    <h1>Nouvelle production</h1>
     ...
     <div class=\"col-lg-3\">
      ...
      <div class=\"col-lg-1\">
        <a href=\"";
        // line 103
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("produir_index", ["id" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 103, $this->source); })())]), "html", null, true);
        ...
        // line 109
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("produir_new", ["id" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 109, $this->source); })())]), "html", null, true);
        echo "\" method=\"post\">
...
\t\t\t\t";
        // line 116
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["equipes"]) || array_key_exists("equipes", $context) ? $context["equipes"] : (function () { throw new RuntimeError('Variable "equipes" does not exist.', 116, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["equipe"]) {
            // line 117
            echo "\t\t\t\t\t<option value=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["equipe"], "id", [], "any", false, false, false, 117), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["equipe"], "nom", [], "any", false, false, false, 117), "html", null, true);
            echo "</option>
\t\t\t\t";
        }
        $_parent = $context['_parent'];
...
<script>
 ...
 ";
    ...
    {
        return array (  388 => 150,  378 => 149,  356 => 135,  345 => 133,  341 => 132,  326 => 119,  315 => 117,  311 => 116,  301 => 109,  292 => 103,  283 => 96,  273 => 92,  267 => 88,  262 => 87,  252 => 83,  246 => 79,  241 => 78,  231 => 74,  225 => 70,  220 => 69,  210 => 68,  194 => 61,  188 => 58,  184 => 56,  174 => 55,  158 => 49,  150 => 44,  142 => 39,  134 => 34,  123 => 26,  112 => 18,  104 => 13,  96 => 8,  91 => 5,  81 => 4,  62 => 3,  39 => 1,);
    }
...
<script>
 ...
 {% endblock %}", "produir/new.html.twig", "C:\\wamp64\\www\\audit\\audit\\templates\\produir\\new.html.twig");
    }
}
