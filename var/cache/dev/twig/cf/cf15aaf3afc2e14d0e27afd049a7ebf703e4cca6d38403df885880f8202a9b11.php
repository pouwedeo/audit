...
class __TwigTemplate_1429eb1fc82a35ba102cd87bea2a033f9120c97de8b8c9174f6075f80dfdacfa extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 69, $this->source); })()), "session", [], "any", false, false, false, 69), "getflashbag", [], "any", false, false, false, 69), "get", [0 => "personnel.succes"], "method", false, false, false, 69));
    ...
    ";
        ...
        echo "     ";
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 87, $this->source); })()), "session", [], "any", false, false, false, 87), "getflashbag", [], "any", false, false, false, 87), "get", [0 => "conteneur.erreur"], "method", false, false, false, 87));
        foreach ($context['_seq'] as $context["_key"] => $context["contenu"]) {
            // line 88
            echo "        <div class=\" text-center alert alert-danger\" role=\"alert\">
    ...
    <h1>Modification du personnel</h1>
     ...
     <div class=\"col-lg-3\">
      ...
      <div class=\"col-lg-1\">
        <a href=\"";
        // line 103
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("personnel_index", ["id" => (isset($context["ide"]) || array_key_exists("ide", $context) ? $context["ide"] : (function () { throw new RuntimeError('Variable "ide" does not exist.', 103, $this->source); })())]), "html", null, true);
        echo "\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Liste des personnels\"  class=\"btn btn-success btn-circle\">
...
<script>
 ...
 ";
    ...
    {
        return array (  327 => 116,  317 => 115,  302 => 110,  292 => 103,  283 => 96,  273 => 92,  267 => 88,  262 => 87,  252 => 83,  246 => 79,  241 => 78,  231 => 74,  225 => 70,  221 => 69,  211 => 68,  195 => 62,  189 => 59,  185 => 57,  175 => 56,  159 => 50,  151 => 45,  143 => 40,  135 => 35,  124 => 27,  112 => 18,  104 => 13,  96 => 8,  91 => 5,  81 => 4,  62 => 3,  39 => 1,);
    }
...
{% endblock %}
{% block body %}
{% for contenu in app.session.getflashbag.get('personnel.succes') %}
    ...
    {% endfor %}
     {% for contenu in app.session.getflashbag.get('personnel.erreur') %}
    ...
    {% endfor %}
     {% for contenu in app.session.getflashbag.get('conteneur.erreur') %}
        <div class=\" text-center alert alert-danger\" role=\"alert\">
  ...
  <div class=\"col-lg-8\">
    <h1>Modification du personnel</h1>
     ...
     <div class=\"col-lg-3\">
      ...
      <div class=\"col-lg-1\">
        <a href=\"{{ path('personnel_index',{'id': ide}) }}\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Liste des personnels\"  class=\"btn btn-success btn-circle\">
          <i class=\"fas fa-clipboard-list\"></i>
        </a>
      </div>
    </div>
...
<script>
 ...
 {% endblock %}", "personnel/edit.html.twig", "C:\\wamp64\\www\\audit\\audit\\templates\\personnel\\edit.html.twig");
    }
}
