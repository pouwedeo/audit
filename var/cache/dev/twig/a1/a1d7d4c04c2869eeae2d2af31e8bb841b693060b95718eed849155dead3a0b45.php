...
class __TwigTemplate_ebf9131b1a6dba40509be9efb3f91ed5ed39faca73a3d6c49d57aac73c1c11b0 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "    <div class=\"row\">
  <div class=\"col-lg-8\">
    <h1>Liste du personnel par équipe </h1>
    </div>
     <div class=\"col-lg-3\">
     </div>
      <div class=\"col-lg-1\">
        <a href=\"";
        // line 75
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("travailler_personnel_new", ["id" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 75, $this->source); })())]), "html", null, true);
        echo "\" title=\"Nouveau travaille \" class=\"btn btn-success btn-circle\">
...
\t</br>
     ...
     <table class=\"table table-bordered\" id=\"example1\" width=\"100%\" cellspacing=\"0\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["travailler_personnels"]) || array_key_exists("travailler_personnels", $context) ? $context["travailler_personnels"] : (function () { throw new RuntimeError('Variable "travailler_personnels" does not exist.', 119, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["travailler_personnel"]) {
            ...
            echo "            <tr>
                <td>";
            // line 121
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["travailler_personnel"], "equipe", [], "any", false, false, false, 121), "nom", [], "any", false, false, false, 121), "html", null, true);
            echo "</td>
                <td>";
            // line 122
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["travailler_personnel"], "personnel", [], "any", false, false, false, 122), "conteneure", [], "any", false, false, false, 122), "html", null, true);
            echo "</td>

                <td>
                 <a href=\"";
            // line 125
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("travailler_personnel_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["travailler_personnel"], "id", [], "any", false, false, false, 125), "ide" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 125, $this->source); })())]), "html", null, true);
            echo "\" title=\"Modifier\" class=\"btn btn-info btn-circle btn-sm\"><i class=\"fas fa-pencil-alt\"></i> </a>
                 <a href=\"";
            // line 126
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("travailler_personnel_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["travailler_personnel"], "id", [], "any", false, false, false, 126), "ide" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 126, $this->source); })())]), "html", null, true);
...
\t";
    ...
    {
        return array (  379 => 148,  375 => 147,  370 => 145,  366 => 144,  362 => 143,  358 => 142,  354 => 141,  348 => 139,  338 => 138,  325 => 134,  316 => 130,  307 => 126,  303 => 125,  297 => 122,  293 => 121,  290 => 120,  285 => 119,  263 => 100,  256 => 96,  248 => 91,  229 => 75,  220 => 68,  210 => 67,  194 => 61,  188 => 58,  184 => 56,  174 => 55,  158 => 49,  150 => 44,  142 => 39,  134 => 34,  123 => 26,  112 => 18,  104 => 13,  96 => 8,  91 => 5,  81 => 4,  62 => 3,  39 => 1,);
    }
  ...
  <div class=\"col-lg-8\">
    <h1>Liste du personnel par équipe </h1>
     ...
     <div class=\"col-lg-3\">
      ...
      <div class=\"col-lg-1\">
        <a href=\"{{ path('travailler_personnel_new', {'id':id }) }}\" title=\"Nouveau travaille \" class=\"btn btn-success btn-circle\">
          <i class=\"fas fa-check\"></i>
        </a>
      </div>
    </div>
...
\t</br>
     ...
     <table class=\"table table-bordered\" id=\"example1\" width=\"100%\" cellspacing=\"0\">
        ...
        {% for travailler_personnel in travailler_personnels %}
            <tr>
                <td>{{ travailler_personnel.equipe.nom }}</td>
                <td>{{ travailler_personnel.personnel.conteneure }}</td>

                <td>
                 <a href=\"{{ path('travailler_personnel_edit', {'id': travailler_personnel.id, 'ide':id}) }}\" title=\"Modifier\" class=\"btn btn-info btn-circle btn-sm\"><i class=\"fas fa-pencil-alt\"></i> </a>
                 <a href=\"{{ path('travailler_personnel_delete', {'id': travailler_personnel.id, 'ide':id}) }}\" title=\"Supprimer\" class=\"btn btn-danger btn-circle btn-sm\"><i class=\"fas fa-trash\"></i> </a>
                </td>
            </tr>
        {% else %}
            <tr>
...
\t
\t{% endblock %}
", "travailler_personnel/index.html.twig", "C:\\wamp64\\www\\audit\\audit\\templates\\travailler_personnel\\index.html.twig");
    }
}
